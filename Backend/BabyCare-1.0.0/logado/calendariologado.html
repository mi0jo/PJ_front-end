        ...
        <div class="container-fluid border-bottom bg-light wow fadeIn" data-wow-delay="0.1s">
            <div class="container topbar bg-primary d-none d-lg-block py-2" style="border-radius: 0 40px">
                ...
                <nav class="navbar navbar-light navbar-expand-xl py-3">
                    <a href="../logado/index.html" class="navbar-brand"><h1 class="text-primary display-6">BleedWith<span class="text-secondary">Dignity</span></h1></a>
                    <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                        <span class="fa fa-bars text-primary"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav d-flex flex-row mx-auto align-items-center">
                        <a href="../logado/index.html" class="nav-item nav-link mx-2">Tela Inicial</a>
                        <div class="nav-item dropdown mx-2">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Educação Sexual</a>
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="../logado/dignidadelogado.html" class="dropdown-item">O que é Dignidade Menstrual?</a>
                        ...
                        <a href="calendariologado.html" class="nav-item nav-link mx-2 active">Calendário Menstrual</a>
